...
export const requestMovie = {
  ...
  fetchBanner: `https://api.themoviedb.org/3/movie/5/similar?api_key=${apiKey}&language=en-US&page=1`,
};
...
export const requestTv = {
  ...
  fetchLatest: "https://api.tvmaze.com/search/shows?q=girls",
  fetchUpcoming: "https://api.tvmaze.com/search/shows?q=boys",
};
