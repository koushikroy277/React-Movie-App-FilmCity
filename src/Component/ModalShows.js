...
export default function ModalShows(props) {
  ...
  return (
    <>
      ...
      <div className="movieModal">
        ...
        <img src={passData.image?.original || passData.image?.medium} alt="" />
        <div className="modalList">
          <h1>{passData?.name}</h1>
          <p>{passData?.summary}</p>
          ...
          <button onClick={() => handleTrailer(passData)}>Play Trailer</button>
        </div>
